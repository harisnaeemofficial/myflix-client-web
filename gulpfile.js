...
var paths = {
    ...
    scriptsApp: [
        ...
        './src/scripts/myflix/animations/index.js',
        './src/scripts/myflix/animations/topbar.js',
        './src/scripts/myflix/animations/items.js',
        './src/scripts/myflix/animations/search.js',
        './src/scripts/myflix/animations/genres.js',
        './src/scripts/myflix/animations/item.js'
    ],
...
gulp.task('gen-scripts', function () {
    return gulp.src(paths.scriptsGlobal.concat(paths.scriptsApp))
        ...
        .pipe(gulpif(!isProductionBuild, replace('var myFlix = {};', 'var myFlix={};myFlix.releaseDate=\'' + new Date() + '\';')))
        .pipe(gulpif(isProductionBuild, replace('var myFlix={};', 'var myFlix={};myFlix.releaseDate=\'' + new Date() + '\';')))
...
gulp.task('gen-styles', function () {
    return gulp.src(paths.styles)
        ...
        .pipe(gulpif(isProductionBuild, minifyCSS({
            discardComments: {
                removeAll: true
            }
        })))
...
gulp.task('gen-index-html', function () {
    return gulp.src(paths.html)
        ...
        .pipe(gulpif(isProductionBuild, minifyHTML({
            removeComments: true,
